...
require_once ('.././conn/conn.php');
 ...
 $to_sql="SELECT COUNT(*) FROM gk_pro";
...
$sql="select * from gk_pro LIMIT ".($page-1)*$PageSize .",$PageSize";
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    ?>
	     <tr>
            ...
            <td><?php echo $row['prosel'];?></td>
            <td><?php echo $row['graa'];?></td>
          <td><?php echo $row['grab'];?></td>
          <td><?php echo $row['grac'];?></td>
        </tr>
        <?php
    }
        ?>
