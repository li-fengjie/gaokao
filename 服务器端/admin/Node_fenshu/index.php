...
require_once ('.././conn/conn.php');
 ...
 $to_sql="SELECT COUNT(*) FROM gk_ev";
...
$sql="select * from gk_ev LIMIT ".($page-1)*$PageSize .",$PageSize";
...
<form class="form-inline definewidth m20" action="index.html" method="get">  
    ...
    <button type="submit" class="btn btn-primary">查询</button>&nbsp;&nbsp; <button type="button" class="btn btn-success" id="addnew">新增（测试用）</button>
</form>
<table class="table table-bordered table-hover definewidth m10" >
    ...
    ?>
	     <tr>
            ...
            <td><?php echo $row['majorselect'];?></td>
            <td><?php echo $row['localselect'];?></td>
            <td><?php echo $row['userregion'];?></td>
            <td><?php echo $row['usergrade'];?></td>
            <td>

                  <a href="edit.php?id=<?php echo $row['id'];?>">修改</a>
                  <a href="delete.php?id=<?php echo $row['id'];?>">删除</a>
                   <a href="watchpage.php?id=<?php echo $row['id'];?>">查看结果</a>
...
<script>
    $(function () {
		...
		$('#addnew').click(function(){
				...
				window.location.href="add.php?id=<?php echo $row['id'];?>";
		 });
